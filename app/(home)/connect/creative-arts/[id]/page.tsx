...
export async function generateMetadata(
  ...
  // read route params
  const id = params.id;
  const url = `https://api.planningcenteronline.com/groups/v2/group_types/30700/groups/${id}?include=location`;
...
export default async function IndividualEvents({
  ...
  const url = `https://api.planningcenteronline.com/groups/v2/group_types/30700/groups/${params.id}?include=location`;

  const eventsUrl = `https://api.planningcenteronline.com/groups/v2/group_types/30700/events?include=group&filter=upcoming`;
