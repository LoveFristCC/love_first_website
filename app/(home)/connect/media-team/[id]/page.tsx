...
export async function generateMetadata(
  ...
  // read route params
  const id = params.id;
  const url = `https://api.planningcenteronline.com/groups/v2/group_types/260323/groups/${id}?include=location`;
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://www.lfcc.tv/connect/media-team/${id}`,
    },
    alternates: {
      canonical: `https://www.lfcc.tv/connect/media-team/${id}`,
    },
  };
}

export default async function IndividualMediaTeam({
  params,
}: {
  params: { id: string };
}) {
