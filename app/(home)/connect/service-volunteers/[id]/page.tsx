...
export async function generateMetadata(
  ...
  // read route params
  const id = params.id;
  const url = `https://api.planningcenteronline.com/groups/v2/group_types/27873/groups/${id}?include=location`;
...
export default async function IndividualLifeClass({
  ...
  const url = `https://api.planningcenteronline.com/groups/v2/group_types/27873/groups/${params.id}?include=location`;

  const eventsUrl = `https://api.planningcenteronline.com/groups/v2/group_types/27873/events?include=group&filter=upcoming`;
