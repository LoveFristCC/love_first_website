...
export async function generateMetadata(
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.lfcc.tv/about-love-first`,
    },
  };
}
      ...
      <section className="historySection">
        ...
        <div className="historyContent">
          <p>
            ...
            to help people connect with God in a church without letting
            structures and programs get in the way. With the help of his family,
            they committed to seeing this dream become a reality—Love First
            Christian Center began on July 28th, 2008. That first Sunday was
            started in a youth room of a rented church, and within 90 days,
            growth forced a move into the main sanctuary on Dixon Drive.
          </p>
          <p>
            Pastor Jomo focused on reaching out to the non-churched community
            and building relationships through outreach and prayer. The
            life-giving message of the Gospel, the passion and joy of Sunday
            Celebrations, and the simple style of Love First Christian Center
            brought immediate growth. In its first year, the church grew to 300
            in weekly attendance.
          </p>
          <p>
            The church established a new location at Riverview High School on
            July 4th, 2010, and a second location for Bible studies, small
            groups, and food pantry in 2011. In its fourth year, Love First
            Christian Center had over 700 in weekly attendance. The church then
            purchased 10 acres of land in the Panther Trace community for its
            future location in May 2012.
          </p>
          <p>
            In March 2016, we moved into our church edifice on 12847 Balm
            Riverview Rd. The building was completed debt-free to the glory of
            God. The building has a total capacity of 1387. The building was
            part of phase one on the property on our campus. We have begun
            building another larger sanctuary with an estimated completion in
            2025, and our current building is to be converted into a community
            center for the youth.
          </p>
          <p>
            As Love First Christian Center heads into its sixteenth year, the
            church has grown to more than 50 members. Love First Christian
            Center offers contemporary, biblically driven worship services alive
            with energy and creativity, excellent childcare, exciting children’s
            and student ministries, and dynamic small groups.
          </p>
          <p>
            God is at work at Love First Christian Center. If you haven’t
            visited, we invite you to see how exciting church can be when the
            focus is simple, and people are free to go after God with passion!
          </p>
